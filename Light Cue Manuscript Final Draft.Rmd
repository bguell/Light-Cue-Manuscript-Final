...
## Model summary alt.
Altervatively, we could use the Anova() function to get p-values using a Wald chi-square tests for each of our main effects...
```{r}
